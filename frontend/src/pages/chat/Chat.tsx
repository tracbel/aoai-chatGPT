                    ...
                    <div className={styles.chatContainer}>
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                ...
                                <h2 className={styles.chatEmptyStateSubtitle}>O TracGPT foi treinado para auxiliar os técnicos com informações sobre equipamentos John Deere da Tracbel Agro.</h2>
                            </Stack>
                        ) : (
                        ...
                        <Stack horizontal className={isMobile ? styles.chatInputMobile : styles.chatInput}>
                            ...
                            <CommandBarButton
                                     ...
                                     styles={{ 
                                         ...
                                         root: {
                                             color: '#FFFFFF',
                                             background: "radial-gradient(109.81% 107.82% at 100.1% 90.19%, #397920 33.63%, #3D9F17 70.31%, #5CCB31 100%)"
                                         },
                                         rootDisabled: {
                                             background: "#BDBDBD"
                                         }
                                ...
                                {/* {appStateContext?.state.isCosmosDBAvailable?.status !== CosmosDBStatus.NotConfigured && <CommandBarButton
                                    ...
                                    styles={{ 
                                        ...
                                        root: {
                                            color: '#FFFFFF',
                                            background: "radial-gradient(109.81% 107.82% at 100.1% 90.19%, #397920 33.63%, #fac937 70.31%, #f7cd4f 100%)"
                                        },
                                        rootDisabled: {
                                            background: "#BDBDBD"
                                        }
